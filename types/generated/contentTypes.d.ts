...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ano: Attribute.BigInteger;
    bluetooth: Attribute.Boolean;
    cambio: Attribute.Enumeration<['Mec\u00E2nico', 'Autom\u00E1tico']>;
    combustivel: Attribute.Enumeration<
      ['Flex', 'Gasolina', 'Diesel', 'Etanol']
    >;
    imgs: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    km: Attribute.BigInteger;
    marca: Attribute.String;
    modelo: Attribute.String;
    motor: Attribute.String;
    obs: Attribute.Text;
    sensor: Attribute.Enumeration<
      ['N\u00E3o tem', 'Traseiro', 'Dianteiro', 'Traseiro e dianteiro']
    >;
    preco: Attribute.BigInteger;
